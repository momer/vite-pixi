...
export const socialMediaProfiles = [
    { title: 'Facebook', to: 'https://facebook.com', icon: FacebookIcon },
    { title: 'Instagram', to: 'https://instagram.com', icon: InstagramIcon },
    { title: 'GitHub', to: 'https://github.com', icon: GitHubIcon },
    { title: 'Dribbble', to: 'https://dribbble.com', icon: DribbbleIcon },
];
